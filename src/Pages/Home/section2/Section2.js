...
const Section2 = () => {
  return (
    <div className="Section_2">
      ...
      <div className="stock-chain">
        <div className="highreturn-box">
          <div className="image-box">
            <img src="../../returns.png" alt="" style={{width:'40%',height:'34%'}}/>
          </div>
        ...
        <div className="tax-benifit">
          <div className="image-box">
            <img src="../../tax.png" alt="" style={{width:'55%',height:'55%'}}/>
          </div>
          <div className="inner-text" >
        ...
        <div className="early-retirement">
          <div className="image-box">
            <img src="../../retirement.png" alt="" style={{width:'40%',height:'34%'}}/>
          </div>
          <div className="inner-text" >
